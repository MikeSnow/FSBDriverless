...
if(NOT "/home/driverless/sim/devel/.private/eufs_msgs/include " STREQUAL " ")
  set(eufs_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/driverless/sim/devel/.private/eufs_msgs/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eufs_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/driverless/sim/src/eufs_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/driverless/sim/devel/.private/eufs_msgs/lib;/home/driverless/sim/devel/lib;/opt/ros/melodic/lib)
