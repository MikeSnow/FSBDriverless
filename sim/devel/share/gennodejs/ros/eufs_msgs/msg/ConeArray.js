...
class ConeArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.blue_cones[i] = geometry_msgs.msg.Point.deserialize(buffer, bufferOffset)
    }
    ...
    for (let i = 0; i < len; ++i) {
      data.yellow_cones[i] = geometry_msgs.msg.Point.deserialize(buffer, bufferOffset)
    }
    ...
    for (let i = 0; i < len; ++i) {
      data.orange_cones[i] = geometry_msgs.msg.Point.deserialize(buffer, bufferOffset)
    }
    ...
    for (let i = 0; i < len; ++i) {
      data.big_orange_cones[i] = geometry_msgs.msg.Point.deserialize(buffer, bufferOffset)
    }
    ...
    for (let i = 0; i < len; ++i) {
      data.unknown_color_cones[i] = geometry_msgs.msg.Point.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 24 * object.blue_cones.length;
    length += 24 * object.yellow_cones.length;
    length += 24 * object.orange_cones.length;
    length += 24 * object.big_orange_cones.length;
    length += 24 * object.unknown_color_cones.length;
    return length + 20;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.blue_cones !== undefined) {
      ...
      for (let i = 0; i < resolved.blue_cones.length; ++i) {
        resolved.blue_cones[i] = geometry_msgs.msg.Point.Resolve(msg.blue_cones[i]);
      }
    }
    else {
      resolved.blue_cones = []
    ...
    if (msg.yellow_cones !== undefined) {
      ...
      for (let i = 0; i < resolved.yellow_cones.length; ++i) {
        resolved.yellow_cones[i] = geometry_msgs.msg.Point.Resolve(msg.yellow_cones[i]);
      }
    }
    else {
    ...
    if (msg.orange_cones !== undefined) {
      ...
      for (let i = 0; i < resolved.orange_cones.length; ++i) {
        resolved.orange_cones[i] = geometry_msgs.msg.Point.Resolve(msg.orange_cones[i]);
      }
    }
    else {
    ...
    if (msg.big_orange_cones !== undefined) {
      ...
      for (let i = 0; i < resolved.big_orange_cones.length; ++i) {
        resolved.big_orange_cones[i] = geometry_msgs.msg.Point.Resolve(msg.big_orange_cones[i]);
      }
    }
    else {
    ...
    if (msg.unknown_color_cones !== undefined) {
      ...
      for (let i = 0; i < resolved.unknown_color_cones.length; ++i) {
        resolved.unknown_color_cones[i] = geometry_msgs.msg.Point.Resolve(msg.unknown_color_cones[i]);
      }
    }
    else {
